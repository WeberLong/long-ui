<template>
<div class="ui-search-bar" :class="{'ui-searchbar-active': focusStatus}">
  <div class="ui-searchbar-input">
    <input type="search" ref="search" @focus="focusStatus = true" @blur="focusStatus = false" v-model="searchText" :placeholder="placeholder">
    <a href="javascript:;" @click="clear" class="ui-searchbar-clear"></a>
  </div>
</div>
</template>
