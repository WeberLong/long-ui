...
export default new Router({
  ...
  routes: [
    ...
    },
    {
      path: '/floatButton',
      name: 'floatButton',
      component: (resolve) => { require(['../pages/floatButton'], resolve) }
    },
    {
      path: '/circular',
      name: 'circular',
      component: (resolve) => { require(['../pages/circular'], resolve) }
    },
    {
      path: '/refreshControl',
      name: 'refreshControl',
      component: (resolve) => { require(['../pages/refreshControl'], resolve) }
    },
    {
      path: '/infiniteScroll',
      name: 'infiniteScroll',
      component: (resolve) => { require(['../pages/infiniteScroll'], resolve) }
    },
    {
      path: '/indexList',
      name: 'indexList',
      component: (resolve) => { require(['../pages/indexList'], resolve) }
    },
    {
      path: '/numberAnimate',
      name: 'numberAnimate',
    ...
    },
    {
      path: '/searchBar',
      name: 'searchBar',
      component: (resolve) => { require(['../pages/searchBar'], resolve) }
    },
    {
      path: '/bottomNav',
      name: 'bottomNav',
      component: (resolve) => { require(['../pages/bottomNav'], resolve) }
    },
    {
      path: '/snackBar',
      name: 'snackBar',
      component: (resolve) => { require(['../pages/snackBar'], resolve) }
    },
    {
      path: '/listView',
      name: 'listView',
      component: (resolve) => { require(['../pages/listView'], resolve) }
    },
    {
      path: '/card',
      name: 'card',
    ...
    },
    {
      path: '/inputs',
      name: 'inputs',
      component: (resolve) => { require(['../pages/inputs'], resolve) }
    },
    {
      path: '/switch',
      name: 'switch',
    ...
    },
    {
      path: '/range',
      name: 'range',
      component: (resolve) => { require(['../pages/range'], resolve) }
    },
    {
      path: '/check',
      name: 'check',
    ...
    },
    {
      path: '/dateSelect',
      name: 'dateSelect',
      component: (resolve) => { require(['../pages/dateSelect'], resolve) }
    },
    {
      path: '/overlay',
      name: 'overlay',
    ...
    },
    {
      path: '/actionSheet',
      name: 'actionSheet',
      component: (resolve) => { require(['../pages/actionSheet'], resolve) }
    },
    {
      path: '/popover',
      name: 'popover',
      component: (resolve) => { require(['../pages/popover'], resolve) }
    },
    {
      path: '/indicator',
      name: 'indicator',
      component: (resolve) => { require(['../pages/indicator'], resolve) }
    },
    {
      path: '/picker',
      name: 'picker',
